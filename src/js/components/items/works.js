...
let items = [
  {
    ...
    brief: "«Академия Звука» – это музыкальное пространство, в котором каждый может искать себя, не отвлекаясь на бытовые проблемы.",
    description:
  ...
  },
  {
    ...
    description: "<p>«Метод» — образовательный проект для писателей и сценаристов кино, для людей, работающих с интересными историями и текстами.</p> <p>«Метод» аккумулирует системы обучения передовых сценарных школ и опыт признанных мастеров. </p> <p>Мы научим правильно оформлять идею в профессиональный синопсис и готовый сценарный проект.</p>",
  ...
  },
  {
    ...
    description: "<p>Образовательный проект для предпринимателей в креативных индустриях.</p> <p>Формируем авторский подход к управлению. Развиваем навыки осознанного лидерства и креативной трансформации бизнеса</p>",
  ...
  },
  {
    ...
    description: "<p>Пошаговый маршрут развития в креативных индустриях, основанный на упорядоченности процессов, гибкости мышления и партнёрстве.</p> <p>Ориентируемся в возможностях рынка и знаем, как эффективно использовать их потенциал. научим, как ими пользоваться.</p>",
  ...
  },
  {
    ...
    description: "<p>Фонд Инносоциум – социальная платформа Фонда Росконгресс, обеспечивающая поддержку социально значимых проектов, креативных отраслей экономики, молодежных инициатив и образования. Мы развиваем креативную экономику, сохраняем культурное наследие и поддерживаем социально-значимые инициативы</p>",
  ...
  },
  {
    ...
    description: "<p>Russian Creative Awards – единственная в мире премия, охватывающая все креативные отрасли. Это высшая награда для творческого сообщества страны, которая ежегодно вручается за вклад в развитие креативного сектора экономики.</p>",
  ...
  },
  {
    ...
    description: "<p>Бесплатная образовательная платформа. Практические курсы по формированию навыков для реализации и упаковки проектов💡</p>",
  ...
  },
  {
    ...
    description: "<p>Российская креативная неделя – это профессиональное сообщество, объединяющее представителей 16 креативных индустрий России. Единственная федеральная площадка, на которой проектируется будущее национальной креативной экономики, отмечаются ключевые достижения и презентуются новые инициативы и проекты.</p>",
  ...
  },
  {
    ...
    description: "<p>Третий окружной форум «Российская креативная неделя – Сибирь» соберет на одной площадке представителей креативного бизнеса, исследовательских компаний, медиарынка, сырьевого бизнеса региона, а также представителей федеральных и региональных органов власти и институтов развития.</p>",
  ...
  },
  {
    ...
    description: "<p>Многопрофильный центр развития креативных индустрий России, инициатор и организатор крупнейших федеральных мероприятий.</p>",
  ...
  },
  {
    ...
    description: "<p>Создать совершенно особенную уютную и престижную обстановку. Камин – способ привнести в дом не только визуальную красоту, но дополнительную функциональность, ведь сегодня виды каминов представлены не только классическими, но и концептуальными современными моделями.</p>",
  ...
  },
  {
    ...
    description: "<p>Подбор и монтаж кондиционеров в Воронеже. При покупке кондиционера получите самые выгодные цены, а так же год обслуживания и доставку бесплатно! Системы кондиционирования для любых задач от официального дилера</p>",
  ...
  },
  {
    ...
    description: "<p>Все виды жалюзи в Воронеже по индивидуальным размерам. Более 750 тканей жалюзи и штор на выбор. Изготовление от 2 дня. Доставка и установка жалюзи по Воронежу и области от интерьерной студии СЭЛТ.</p>",
  ...
  },
  {
    ...
    description: "<p>Главный парк столицы превратится в игровую и образовательную площадку, объединяющую театр, цирк, науку, искусство, музыку и танец. Ждем всех желающих!</p>",
  ...
  },
  {
    ...
    description: "<p>Nero Digital - Агентство по дизайну и разработке цифровых продуктов, предлагающее услуги в области дизайна продуктов, разработки веб- и мобильных приложений, дизайна пользовательского интерфейса /UX и консалтинга в области цифровой трансформации.</p>",
  ...
  },
  {
    ...
    description: "<p>NERA помогает быстрее получить желаемое и достичь любых целей.</p> <p>Образовательные практики основаны на знаниях и опыте экспертов из разных областей: психологов, сертифицированных бизнес- тренеров, предпринимателей, HR - специалистов</p>",
    link: "https://nera.one/",
    rate: "62",
    layout:
  ...
  },
  {
    ...
    description: "<p>Ценности — основа целей, они помогают сохранять мотивацию и не идти за чужими мечтами. Этот воркшоп поможет тебе осознать свои истинные ценности, синхронизировать свои цели и сформулировать план их достижения.</p>",
  ...
  },
  {
    ...
    description: "<p>Фестиваль-путешествие «Достоевский» — первое культурное событие, сомасштабное личности писателя. Он обозначит новую точку в топографии русской литературы. Современные форматы и жанры позволят взглянуть на Достоевского в новом ракурсе и сократить дистанцию между писателем и аудиторией.</p>",
  ...
  },
  {
    ...
    description: "<p>Удобная организация командировок и деловых поездок на платформе «Millennium». Услуги организации деловых поездок сотрудников.</p> <p>Профессиональный сервис по организации командировок и MICE мероприятий.</p>",
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h6 class="modal-title text-xs-left text-sm-center text-md-center">${item.title}</h6>
          </div>
